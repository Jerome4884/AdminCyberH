...
$sqlTitre = "SELECT `titre` FROM cyberharcelement.`presentation`;"; // WHERE `titre` = :titre;"; 
...
$sqlA = "SELECT `article` FROM cyberharcelement.`presentation`;"; // WHERE `presentation_id` = :id;"; 
...
if ((isset($_POST['submit'])) && (!isset($_POST['titre'])) || (!isset($_POST['article']))) {
...
// var_dump($_POST['text']);
    ...
    $queryAdd->bindValue(':titre', $titre, PDO::PARAM_STR);
    $queryAdd->bindValue(':article', $article, PDO::PARAM_STR);
