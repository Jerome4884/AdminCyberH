    ...
    <main class="container mt-5">
      ...
      <div class="d-flex justify-content-center flex-wrap">
        ...
        <div class="card m-3" style="width: 15rem;">
          ...
          <div class="card-body d-flex flex-column align-items-center justify-content-center">
            <div class="text-center">
              <h3 class="card-title" id="text"><small>Modification</small></h3>
            </div>
            <div class="mt-auto">
              <a href="?routing=update" class="btn btn-primary mt-4">Go</a>
            </div>
          </div>
        </div>
        <div class="card m-3" style="width: 15rem;">
          ...
          <div class="card-body d-flex flex-column align-items-center justify-content-center">
            <div class="text-center">
              <h3 class="s-en-premunir" id="text"><small>Suppression</small></h3>
            </div>
            <div class="mt-auto">
              <a href="?routing=delete" class="btn btn-primary mt-4">Go</a>
            </div>
          </div>
        </div>
